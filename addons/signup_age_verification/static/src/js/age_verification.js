...
var AgeVerification = {
    ...
    verify: function(event) {
        ...
        if(+day && +month && +year && year.length == 4) {
            ...
            if(AgeVerification.is_older_than(date, 18)) {
                // Good to go :)
    ...
    is_form_readonly: function(date, age) {
        ...
        Detect that.
        */
        day_ro = $('#birthdate_day').prop('readonly');
        month_ro = $('#birthdate_month').prop('readonly');
        year_ro = $('#birthdate_year').prop('readonly');
